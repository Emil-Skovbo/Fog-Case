                ...
                <form id="addProduct" action="?action=order" method="POST">
                    ...
                    <table class="table table-striped">
                        ...
                        <tbody>
                                ...
                                <td><input type="text" name="hight" placeholder="Hight in cm" id="qtyInput"></td>
                                <td><input type="text" name="length" placeholder="Length in cm" id="qtyInput"></td>
                                <td><input type="text" name="width" placeholder="Width in cm" id="qtyInput"></td>
                                <td><input type="text" name="type" placeholder="material" id="qtyInput"></td>
